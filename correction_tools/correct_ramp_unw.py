...
--suffix_azimuth_file   Suffix of .flatz azimuth file $prefix_azimuth_file$date1-$date2$suffix_azimuth_file.flata
--preffix_azimuth_file  Preffix of .flatz azimuth file $prefix_azimuth_file$date1-$date2$suffix_azimuth_file.flata
...
for kk in range((kmax)):
    ...
    fig.savefig(folder+'add_ramp_corrrection.eps', format='EPS',dpi=150)
